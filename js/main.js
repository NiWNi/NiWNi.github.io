...
var slideBuildings = document.querySelector('#Buildings');
var slideClouds = document.querySelector('#Clouds');
var slideRain = document.querySelector('#Rain');
var cloudFive = document.querySelector('#Cloud5');

function checkClass() {
  if (slideBuildings.classList.contains('buildings')) {
    var computedStyle = window.getComputedStyle(slideBuildings);
...
var circleNav = document.querySelector('.circle-nav');
...
var liLinks = document.querySelectorAll('.navigation-list li');
